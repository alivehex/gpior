...
#if _USE_LFN
	XCHAR	lfname[255];		/* Pointer to the LFN buffer */
...
FRESULT f_opendir (FATDIR*, const XCHAR*);				/* Open an existing directory */
FRESULT f_readdir (FATDIR*, FILINFO*);					/* Read a directory item */
